...
#include <cstdio>
CprHanmoOuJrJrAi::CprHanmoOuJrJrAi(){
    RFXGa=0;
}
...
void CprHanmoOuJrJrAi::playerStrategy() {
...
void CprHanmoOuJrJrAi::Delete_Card(CprCard c){
...
bool CprHanmoOuJrJrAi::Dfs(int type,int count){
...
void CprHanmoOuJrJrAi::prepareHand(){
    if(RFXGa){
...
int CprHanmoOuJrJrAi::compareFlush(const CardList &a,const CardList &b){
    for(int i=0;i<=4;i++){
...
bool CprHanmoOuJrJrAi::compareStraightFlush(){
    for(int i=0;i<=4;i++){
...
void CprHanmoOuJrJrAi::Special1(){
    for(int i=0;i<=2;i++){
        L[i].clear();
    }
